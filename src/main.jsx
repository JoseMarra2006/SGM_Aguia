...
async function bootstrap() {
  ...
  // Quando supabase.js e authStore.js forem instanciados (dentro do App),
  // o CapacitorStorage.getItem já responderá de forma síncrona e instantânea.
  await warmupStorage();

  // Importação dinâmica garante que App (e suas dependências: supabase.js,
  // authStore.js) só sejam instanciados DEPOIS do warmup concluído.
